...
const ProjectWBSPage = () => {
  ...
  const renderScheduleBar = (start, end) => {
    ...
    const totalDuration = Math.max(
      1,
      Math.floor((projectEnd - projectStart) / oneDay) + 1
    );
    ...
    return (
      <div
        className="position-relative w-100 border"
        style={{ height: "24px" }}
      >
        <div
  ...
  return (
    <div className="container-fluid p-0 vh-100 overflow-auto">
